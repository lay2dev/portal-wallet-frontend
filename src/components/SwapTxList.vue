<template>
  <div class="column q-py-xs bg-white relative-position" style="border-radius: 5px">
      ...
      <q-card style="width: 700px; max-width:80vw">
        ...
        <q-card-section class="section column q-gutter-sm">
          <div class="column">
            ...
            >{{displayFromAmount(selectedTx.fromAmount, selectedTx.fromDecimal)}} {{selectedTx.fromSymbol}}</span>
          </div>
          <div class="column">
            <span class="col-3 text-caption text-grey">{{$t('swap.label.hash')}}:</span>
            <span class="col-8 text-caption text-dark" style="word-break: break-word">
              {{selectedTx.fromHash}}
              <q-btn
                color="grey"
                icon="content_copy"
